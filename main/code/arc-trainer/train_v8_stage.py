...
base_path = '/ocean/projects/cis250063p/jbentley/ARC-AGI-2/Capstone-ARC2/shared/arc/data/ARC-Data/input/stage0/input'
# input paths
...
arc_heavy_path = os.path.join(base_path, 'ARC-Heavy')  # https://github.com/neoneye/arc-dataset-collection)
    ...
    for action in ['train', 'merge']:
        ...
        if action == 'train':
            ...
            if rank in (-1, 0):
                ...
                # ADDED THIS STAGING
                arc_heavy_set = ArcDataset.load_from_json(os.path.join(arc_heavy_path, 'arc_heavy_challenges.json'))
                arc_heavy_set = arc_heavy_set.load_solutions(os.path.join(arc_heavy_path, 'arc_heavy_solutions.json'))
                ...
                mix_datasets = {
                    "arcHeavy": arc_heavy_set.move_test_to_train(),
                    "arcCDG": arc_cdg_set.move_test_to_train().repeat(5),
                }
